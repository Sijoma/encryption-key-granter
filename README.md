...
```sh
make docker-build docker-push IMG=<some-registry>/key-encryption-granter:tag
```
...
```sh
make deploy IMG=<some-registry>/key-encryption-granter:tag
```
